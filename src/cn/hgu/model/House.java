...
public class House  implements java.io.Serializable {
    ...
    /** full constructor */
    public House(Integer id, Users users, Types types, Street street, String title, String description, Integer price, Date pubdate, Short floorage, String contact) {
        this.id = id;
        this.users = users;
        this.types = types;
        this.street = street;
